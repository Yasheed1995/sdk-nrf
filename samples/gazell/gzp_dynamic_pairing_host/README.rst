...
You must follow the instructions and use of files from this page, and the :ref:`gzp_dynamic_pairing_device` sample.
...
.. note::
   You must follow the steps from and include the :ref:`_gzp_dynamic_pairing_device` sample in addition to this sample.
...
You can use this sample to learn how the :ref:`gzp` subsystem can be used to establish a secure link between two devices using the Gazell protocol.”
